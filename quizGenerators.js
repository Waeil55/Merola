// Utility for Coin Images - Updated to the Merola Repo
const COIN_URLS = {
...
function generateShapesData() {
    ...
    for (let i = 0; i < 40; i++) {
        ...
        let wrongs = allOptions.filter(opt => opt !== correct).sort(() => 0.5 - Math.random()).slice(0, 3);
